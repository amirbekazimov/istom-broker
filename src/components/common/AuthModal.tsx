...
export function AuthModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent
        className={`sm:max-w-[570px] ${err ? "bg-[#FF6565]" : "bg-[#F4F4F4]"}`}
      >
        {login ? (
                  ...
                  <div className="flex space-x-4 mt-2">
                    <label className="flex items-center">
                      <input
                        ...
                        onChange={(e) => setUserType("Партнер")}
                        className="mr-2"
                      />
                      Партнер
                    </label>
                  ...
                  <>
                    <div className="mt-4">
                      <label
                        ...
                        className="text-[14px] md:text-[18px] text-[#00000080]"
                      >
                        Имя <span className="text-[#FF6565]">*</span>
                      </label>
                      <input
                        type="text"
                        name="firstname"
                    ...
                    <div className="mt-4">
                      <label
                        ...
                        className="text-[14px] md:text-[18px] text-[#00000080]"
                      >
                        Фамилия <span className="text-[#FF6565]">*</span>
                      </label>
                      <input
                        type="text"
                        name="lastname"
                    ...
                    <div className="mt-4">
                      <label
                        ...
                        className="text-[14px] md:text-[18px] text-[#00000080]"
                      >
                        Номер телефона <span className="text-[#FF6565]">*</span>
                      </label>
                      <input
                        type="text"
                        name="number"
